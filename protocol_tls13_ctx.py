...
from protocol_tls13_extensions import ExtensionType
from protocol_tls13_ciphersuite import CipherSuite
from protocol_tls13_ext_supportedgroups import NamedGroup
...
class TLSContext:
    ...
    def key_schedule_in_handshake(self):
        ...
        print('[+] c hs traffic:', self.client_hs_traffic_secret.hex())
        print('[+] s hs traffic:', self.server_hs_traffic_secret.hex())
    ...
    def key_schedule_in_app_data(self):
        ...
        print('[+] c ap traffic:', self.client_app_traffic_secret.hex())
        print('[+] s ap traffic:', self.server_app_traffic_secret.hex())
