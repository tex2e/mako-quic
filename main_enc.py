...
import os
from metatype import Uint8, Uint16, Uint32, Uint64, List, Opaque, OpaqueUint8, OpaqueVarLenIntEncoding, VarLenIntEncoding, OpaqueLength
...
from protocol_longpacket import LongPacket, PacketType, InitialPacket, LongPacketFlags
